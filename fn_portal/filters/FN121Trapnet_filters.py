...
class FN121TrapnetFilter(FN121AttributeFilter):
    ...
    vegetation__gte = django_filters.NumberFilter(field_name="vegetation", lookup_expr="gte")
    vegetation__lte = django_filters.NumberFilter(field_name="vegetation", lookup_expr="lte")
    vegetation__gt = django_filters.NumberFilter(field_name="vegetation", lookup_expr="gt")
    vegetation__lt = django_filters.NumberFilter(field_name="vegetation", lookup_expr="lt")
    ...
    lead_angle = django_filters.NumberFilter(field_name="lead_angle", lookup_expr="exact")
    lead_angle__gte = django_filters.NumberFilter(field_name="lead_angle", lookup_expr="gte")
    lead_angle__lte = django_filters.NumberFilter(field_name="lead_angle", lookup_expr="lte")
    lead_angle__gt = django_filters.NumberFilter(field_name="lead_angle", lookup_expr="gt")
    lead_angle__lt = django_filters.NumberFilter(field_name="lead_angle", lookup_expr="lt")
