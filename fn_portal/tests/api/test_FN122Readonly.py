"""=============================================================
 ~/fn_portal/fn_portal/tests/api/test_FN122Readonly.py
 Created: 03 Jun 2021 11:31:56

 DESCRIPTION:

  The FN122 readonly endpoint should return a list of efforts.  The
...
from ...tests.factories import FN011Factory, FN121Factory, FN122Factory
...
def fn122_records():
    ...
    eff2 = FN122Factory(sample=fn121, eff="002")

    return [eff1, eff2]


@pytest.mark.django_db
def test_FN122Readonly_list(api_client, fn122_records):
    """when we access the readonly endpoint for FN122 objects, it should
    return a paginated list of efforts that includes all of the FN122
...
def test_FN122Readonly_only_get_allowed(api_client):
    """Only get requests are allowed on the FN122 readonly endpoint.  This
...
@pytest.mark.xfail
def test_FN122Readonly_filters():
    """The readonly api endpoint for FN122 objects accepts a large number
    ...
    the filter to apply, and a list of the FN122 slugs expected in the
    response.
