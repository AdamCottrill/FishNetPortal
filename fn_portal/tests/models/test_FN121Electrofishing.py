...
invalid_args = [
    ...
    ("volts_min", -10, "Ensure this value is greater than or equal to 0."),
    ("volts_min", 1500, "Ensure this value is less than or equal to 1200."),
    ("volts_max", -10, "Ensure this value is greater than or equal to 0."),
    ("volts_max", 1500, "Ensure this value is less than or equal to 1200."),
    ...
    ("amps_min", -10, "Ensure this value is greater than or equal to 0."),
    ("amps_min", 81, "Ensure this value is less than or equal to 80."),
    ("amps_max", -10, "Ensure this value is greater than or equal to 0."),
    ("amps_max", 81, "Ensure this value is less than or equal to 80."),
    ("amps_mean", -10, "Ensure this value is greater than or equal to 0."),
    ("amps_mean", 81, "Ensure this value is less than or equal to 80."),
    ("power_min", -10, "Ensure this value is greater than or equal to 0."),
    ("power_min", 15001, "Ensure this value is less than or equal to 15000."),
    ("power_max", -10, "Ensure this value is greater than or equal to 0."),
    ("power_max", 15001, "Ensure this value is less than or equal to 15000."),
