# Generated by Django 3.2.12 on 2022-11-16 09:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('volts_minimum', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(1200)])),
                ('volts_maximum', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(1200)])),
                ...
                ('amps_minimum', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(80)], verbose_name='Minimum current observed a sample or transect.')),
                ('amps_maximum', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(80)], verbose_name='Maximum current observed a sample or transect.')),
                ...
                ('power_minimum', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(15000)], verbose_name='Minimum power output during an electrofishing sample.')),
                ('power_maximum', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(15000)], verbose_name='Maximum power output during an electrofishing sample.')),
