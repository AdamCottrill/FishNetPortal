...
class Migration(migrations.Migration):
    ...
    replaces = [('fn_portal', '0034_fn012_and_fn012Defaults_tables'), ('fn_portal', '0035_fn012_allow_null_fdsam2_and_agedec2'), ('fn_portal', '0036_rename_fn012Default_to_FN012Protocol'), ('fn_portal', '0037_remove_flen2tlen_from_fn012_tables'), ('fn_portal', '0038_add_fn012_lammrk'), ('fn_portal', '0039_populate_fn012Protocol')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sample_specs', to='fn_portal.FN011')),
                ('species', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fn012_sample_specs', to='common.Species')),
                ('lamsam', models.CharField(choices=[('0', 'Not Collected'), ('1', 'XLAM (NO LONGER SUPPORTED)'), ('2', 'LAMIJC')], default=2, help_text='Lamprey Reporting', max_length=1)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('k_max_error', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5.0)], verbose_name='Maximum K (FLEN) - error')),
                ('k_max_warn', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(4.0)], verbose_name='Maximum K (FLEN) - warning')),
                ('lake', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sample_specs', to='common.Lake')),
                ('protocol', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sample_specs', to='fn_portal.FNProtocol')),
                ('species', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fn012protocol_sample_specs', to='common.Species')),
                ('lamsam', models.CharField(choices=[('0', 'Not Collected'), ('1', 'XLAM (NO LONGER SUPPORTED)'), ('2', 'LAMIJC')], default=2, help_text='Lamprey Reporting', max_length=1)),
            ],
            options={
